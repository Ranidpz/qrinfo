...
export const qbetTranslations = {
  he: {
    enterAria: 'כניסה לניחוש',
    registerTitle: 'הרשמה לניחוש',
    ...
    sendPrediction: 'שליחת הניחוש',
    savingPrediction: 'שולחים...',
    doneTitle: 'הניחוש נקלט!',
    waitingForResult: 'המערכת קלטה את הניחוש שלכם — חכו לסוף המשחק',
    yourPick: 'הניחוש שלכם',
    editPrediction: 'שינוי הניחוש',
    lockedTitle: 'הניחושים נעולים',
    lockedText: 'המשחק כבר יצא לדרך — לא ניתן לנחש יותר',
    untilKickoff: 'עד שריקת הפתיחה',
    matchStarted: 'המשחק התחיל!',
    hoursLabel: 'שעות',
    minutesLabel: 'דקות',
    secondsLabel: 'שניות',
    finalResultTitle: 'התוצאה הסופית',
    youWon: 'כל הכבוד! ניחשתם נכון',
    youWonSub: 'אתם בין הזוכים בניחוש',
    youLost: 'לא הפעם...',
    youLostSub: 'תודה שהשתתפתם!',
    genericError: 'משהו השתבש, נסו שוב',
    rateLimited: 'יותר מדי בקשות — המתינו רגע ונסו שוב',
    cannotChange: 'הניחוש כבר נקלט — לא ניתן לשנות אותו במשחק הזה',
    sendFailed: 'שליחת הקוד נכשלה — בדקו את המספר ונסו שוב',
    closesAt: 'הניחוש נסגר ב-{time}',
