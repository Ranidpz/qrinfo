...
const translations: Record<string, Record<string, string>> = {
  he: {
    ...
    infoDesc3: 'שחקו, שתפו עם חברים ותזכו בדירוג וחבילות פרסים.',
    infoDesc3Note: '*הפרסים בהתאם להגדרות יוצר המיני גיימס ב-The Q',
  ...
  en: {
    ...
    infoDesc3: 'Play, share with friends and earn rankings and prize packs.',
    infoDesc3Note: '*Prizes based on the mini games creator\'s settings in The Q',
