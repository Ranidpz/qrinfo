  ...
  return <div className="mx-auto max-w-5xl space-y-6 text-text-primary">
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <section className={panel} aria-labelledby="download-title">
        ...
        <a className={button} href="/downloads/TheQ-WhatsApp-Agent-0.7.1.zip" download>{t('downloadMac')}</a>
        <p className="mt-3 text-xs text-text-secondary">{t('requirements')}</p>
        <a className="mt-3 block text-sm text-accent underline" href="/downloads/TheQ-WhatsApp-Agent-0.7.1.zip.sha256" download>{t('checksum')}</a>
      </section>
    </div>
