  ...
  const content = {
    he: {
      ...
      sections: [
        {
          title: '1. מבוא',
          content: 'ברוכים הבאים ל-The Q By Playzone ("האפליקציה", "השירות"). אנו מכבדים את פרטיותכם ומחויבים להגן על המידע האישי. מדיניות פרטיות זו מסבירה כיצד אנו אוספים, משתמשים ומגנים על המידע.',
        },
        {
          title: '2. מידע שאנו אוספים',
          content: 'כאשר משתמשים בשירות שלנו, אנו עשויים לאסוף את המידע הבא:',
          list: [
            'מידע מחשבון Google: שם, כתובת אימייל ותמונת פרופיל (בעת התחברות באמצעות Google)',
            'תוכן שנוצר: קודי QR, תמונות, סרטונים וחידות שמועלים לשירות',
            'נתוני שימוש: מידע על האופן שבו משתמשים בשירות',
          ],
        },
        {
        ...
        {
          title: '4. שיתוף מידע',
          content: 'אנו לא מוכרים, סוחרים או מעבירים מידע אישי לצדדים שלישיים, למעט ספקי שירות הנדרשים להפעלת השירות (כגון Firebase של Google).',
        },
        {
          title: '5. אבטחת מידע',
          content: 'אנו מיישמים אמצעי אבטחה מתאימים כדי להגן על המידע האישי מפני גישה, שינוי, חשיפה או השמדה בלתי מורשית.',
        },
        {
          title: '6. זכויות המשתמשים',
          content: 'למשתמשים יש הזכות:',
          list: [
            'לגשת למידע האישי',
            'לתקן מידע לא מדויק',
            'לבקש מחיקת המידע',
